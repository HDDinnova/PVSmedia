...
define('DB_NAME', 'el1y04t4_portfolio');

/** El teu nom d'usuari a MySQL */
define('DB_USER', 'el1y04t4_admport');

/** La teva contrasenya a MySQL */
define('DB_PASSWORD', 'PVSm3d1a@2016');
 ...
 * @since 2.6.0
 */
define('AUTH_KEY', 			'PVSmedia');
define('SECURE_AUTH_KEY', 	'Santi Valldeperez');
define('LOGGED_IN_KEY', 	'Nadal 2016');
define('NONCE_KEY', 		'PvSm3d14');
define('AUTH_SALT',        	'PVSm3d1a@2106');
define('SECURE_AUTH_SALT', 	'#%PVSm3d1a@2106%#');
define('LOGGED_IN_SALT',   	'PVSm3d1a@2106');
define('NONCE_SALT',       	'PVSm3d1a@2106#PVSm3d1a@2106');
/**#@-*/
